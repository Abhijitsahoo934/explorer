...
export default function FinalCTA() {
  ...
  return (
    <section ref={containerRef} id="cta" className="relative py-28 px-6">
      <div className="container mx-auto max-w-5xl">
        <div className="cta-content rounded-[2.2rem] border border-border bg-card/70 p-10 md:p-14 shadow-premium backdrop-blur-2xl text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-muted leading-8">
            Explorer helps you move from browser clutter to a setup that feels structured, calm, and ready every time you work.
          </p>
