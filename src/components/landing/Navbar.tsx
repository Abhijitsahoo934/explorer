...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 border-b border-border/70 bg-background/78 backdrop-blur-2xl transition-all duration-300">
      <div className="h-px w-full bg-linear-to-r from-accent/0 via-sky-400/45 to-accent/0" />
